                ...
                <NavLink
                  ...
                  className={({ isActive }) => 
                    `text-sm font-medium uppercase tracking-widest transition-colors ${
                      isActive ? 'text-luxury-jade dark:text-luxury-gold' : 'text-gray-600 dark:text-gray-300 hover:text-luxury-jade dark:hover:text-luxury-gold'
                    }`
                  }
                >
                  {item.label}
            ...
            {NAV_ITEMS.map((item) => {
               ...
               return isHash ? (
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `block px-3 py-4 text-base font-medium border-b border-gray-100 dark:border-white/5 ${
                      isActive ? 'text-luxury-jade dark:text-luxury-gold' : 'text-gray-800 dark:text-gray-200 hover:text-luxury-jade dark:hover:text-luxury-gold'
                    }`
                  }
                >
                  {item.label}
