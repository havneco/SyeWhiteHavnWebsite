              ...
              <div key={app.id} className="glass-panel p-6 rounded-2xl flex flex-col h-full hover:-translate-y-1 hover:border-luxury-jade dark:hover:border-luxury-gold transition-all duration-300 group relative overflow-hidden">
                ...
                {hasLink ? (
                  <a 
                    ...
                    className="mt-auto inline-flex items-center text-sm font-bold text-gray-900 dark:text-white hover:text-luxury-jade dark:hover:text-luxury-gold transition-colors relative z-10"
                  >
                    Launch Tool <ExternalLink size={14} className="ml-2" />
                  </a>
                ) : (
                  <a 
                    href={`mailto:${CONTACT_INFO.email}?subject=Request Access: ${app.name}`}
                    className="mt-auto inline-flex items-center text-sm font-bold text-gray-500 dark:text-gray-400 hover:text-luxury-jade dark:hover:text-luxury-gold transition-colors relative z-10"
                  >
